<style>
    .list-group#listReservasi {
        ...
        flex-direction: row;
        flex-wrap: wrap;
        max-height: 124px; /* Tentukan tinggi maksimum daftar */
        overflow-y: auto; /* Tambahkan scroll vertikal jika terlalu banyak item */
    ...
    <?php foreach ($reservasi as $datareservasi) : ?>
        <li class="list-group-item" onclick="toggleSelection(this, <?php echo $datareservasi['id_reservasi']; ?>)">
            <div class="d-flex align-items-center" style="cursor:pointer;">
                <div class="flex-fill">
                    <span><?php echo $datareservasi['asal_kota'] . '-' . $datareservasi['tujuan_kota']; ?></span>
                    <?php
                ...
                <div>
                    <div>
                        <label class="badge badge-success p-2" title="Kursi tersedia"><?= $datareservasi['total_tersedia']; ?></label>
                    </div>
                </div>
            </div>
        </li>
