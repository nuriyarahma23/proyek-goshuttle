                          ...
                          <div class="col-8">
                              <div class="row">
                                    ...
                                    <div class="col-3 mt-3">
                                        ...
                                        <input type="number" name="commission"  class="form-control" step=any  value="<?php echo old('commission') ?? $agentdetail->commission?>" placeholder="<?php echo lang("Localize.commission") ?> %" aria-label="commission">
                                    </div>
