 ...
 <table class="table display table-bordered table-striped table-hover basic" id="schedulelist">
  ...
  <?php foreach ($schedule as $kye => $schedulevalue) : ?>
    ...
    <tr>
      ...
      <td><?php echo $schedulevalue->start_time; ?></php></td>
      <td><?php echo $schedulevalue->end_time; ?></php></td>
      
      <td>

        <form action="<?php echo base_url(route_to('delete-schedule',$schedulevalue->id ))?>" id="locatindelete" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
