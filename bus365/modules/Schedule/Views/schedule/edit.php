...
<form action="<?php echo base_url(route_to('update-schedule',$schedule->id))?>" id="employee" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
 ...
 <div class="col-4 ">
 <label for="start_time" class="form-label"> <?php echo lang("Localize.start") ?> <?php echo lang("Localize.time") ?></label>
  ...
  <div class="col-4">
  <label for="end_time" class="form-label"> <?php echo lang("Localize.end") ?> <?php echo lang("Localize.time") ?></label>
