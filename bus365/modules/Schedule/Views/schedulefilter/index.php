  ...
  <?php foreach ($schedulefilter as $kye => $schedulevalue) : ?>
    ...
    <tr>
      ...
      <td>
        ...
        <form action="<?php echo base_url(route_to('delete-schedulefilter',$schedulevalue->id ))?>" id="locatindelete" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
