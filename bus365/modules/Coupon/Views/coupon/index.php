...
<div class="card mb-4">
      ...
      <?php if ($add_data == true) : ?>  
            <div class="text-end">
                <a class="btn btn-success" href="<?php echo base_url(route_to( 'new-coupon' )) ?>"><?php echo lang("Localize.add_coupon") ?></a>
            </div>
      <?php endif ?>
 ...
 <table class="table display table-bordered table-striped table-hover basic" id="couponlist">
  ...
  <?php foreach ($coupon as $kye =>  $value) : ?>
    ...
    <td>
          ...
          <form action="<?php echo base_url(route_to('delete-coupon',$value->id ))?>" id="locatindelete" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
