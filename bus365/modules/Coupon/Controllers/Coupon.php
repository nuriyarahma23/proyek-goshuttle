...
class Coupon extends BaseController
{
	...
	public function new()
	{
		...
		echo view($this->Viewpath.'\coupon/new',$data);
	}
	...
	public function create()
	{
		...
		if($this->validation->run($data, 'coupon'))
		{
	...
	public function index()
	{
		...
		echo view($this->Viewpath.'\coupon/index',$data);
	}
	...
	public function edit($id)
	{
		...
		echo view($this->Viewpath.'\coupon/edit',$data);
	}
	...
	public function update($id)
	{
		...
		if($this->validation->run($validdata, 'coupon'))
		{
			$this->couponModel->save($data);
