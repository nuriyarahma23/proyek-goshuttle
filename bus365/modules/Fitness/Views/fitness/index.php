 ...
 <table class="table display table-bordered table-striped table-hover basic" id="fitnesslist">
  <thead>
    <tr>
      ...
      <th scope="col"><?php echo lang("Localize.name") ?> <?php echo lang("Localize.date") ?> </th>
      <th scope="col"><?php echo lang("Localize.name") ?> <?php echo lang("Localize.date") ?> </th>
      <th scope="col"><?php echo lang("Localize.name") ?> <?php echo lang("Localize.milage") ?> </th>
  ...
  <?php foreach ($fitness as $kye =>  $value) : ?>
    ...
    <td>
          ...
          <form action="<?php echo base_url(route_to('delete-fitness',$value->id ))?>" id="locatindelete" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
