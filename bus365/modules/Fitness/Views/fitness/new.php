...
<div class="card mb-4">
      <div class="card-body">
			...
			<form action="<?php echo base_url(route_to('create-fitness')) ?>" id="fitnessform" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
				...
				<label for="fitness_name" class=""><?php echo lang("Localize.fitness") ?> <?php echo lang("Localize.name") ?> </label>
				...
				<div class="col-4 mt-2" id="payment_method">
                        <label for="vehicle_id"><?php echo lang("Localize.vehicle") ?> <?php echo lang("Localize.reg") ?> <?php echo lang("Localize.no") ?></label>
				...
				<label for="start_date" class="form-label"><?php echo lang("Localize.fitness") ?> <?php echo lang("Localize.start") ?> <?php echo lang("Localize.date") ?></label>
				...
				<label for="start_milage" class=""><?php echo lang("Localize.start") ?> <?php echo lang("Localize.milage") ?> </label>
					<input type="text" id="start_milage" name ="start_milage" value="<?php echo esc(old('start_milage')) ?>"  class="form-control text-capitalize"  placeholder="<?php echo lang("Localize.start") ?> <?php echo lang("Localize.milage") ?>">
				</div>

				<div class="col-4 mt-3">
				<label for="end_milage" class=""><?php echo lang("Localize.end") ?> <?php echo lang("Localize.milage") ?> </label>
					<input type="text" id="end_milage" name ="end_milage" value="<?php echo esc(old('end_milage')) ?>"  class="form-control text-capitalize"  placeholder="<?php echo lang("Localize.end") ?> <?php echo lang("Localize.milage") ?>">
				</div>
