		...
		<form action="<?php echo base_url(route_to('update-fitness', $fitness->id)) ?>" id="fitnessedit" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<label for="start_milage" class=""><?php echo lang("Localize.start") ?> <?php echo lang("Localize.milage") ?></label>
					<input type="text" id="start_milage" name ="start_milage" value="<?php echo esc(old('start_milage') ?? $fitness->start_milage) ?>"  class="form-control text-capitalize"  placeholder="Start Milage">
				</div>

				<div class="col-4 mt-3">
				<label for="end_milage" class=""><?php echo lang("Localize.end") ?> <?php echo lang("Localize.milage") ?></label>
					<input type="text" id="end_milage" name ="end_milage" value="<?php echo esc(old('end_milage') ?? $fitness->end_milage) ?>"  class="form-control text-capitalize"  placeholder="End Milage">
				</div>
