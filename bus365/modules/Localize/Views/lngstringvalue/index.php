 ...
 <table class="table display table-bordered table-striped table-hover basic" id="languageStringValue">
  ...
  <?php foreach ($lanStrValue as $kye =>  $value) : ?>
    ...
    <tr>
      ...
      <td>
        <input type="text" id="strvalue" name ="strvalue[]" value="<?php echo esc($value->value)  ?>" class="form-control text-capitalize"  placeholder="<?php echo lang("Localize.language") ?> <?php echo lang("Localize.string") ?> <?php echo lang("Localize.value") ?>"> 
