...
<div class="card mb-4">
      ...
      <?php if ($add_data == true) : ?>  
            <div class="text-end">
                <a class="btn btn-success" href="<?php echo base_url(route_to( 'new-blog' )) ?>"><?php echo lang("Localize.add_blog") ?></a>
            </div>
      <?php endif ?>
 ...
 <table class="table display table-bordered table-striped table-hover basic" id="bloglist">
  ...
  <?php foreach ($blog as $kye =>  $value) : ?>
    ...
    <tr>
      ...
      <td>
          <form action="<?php echo base_url(route_to('delete-blog',$value->id ))?>" id="sectiotwodetail" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
