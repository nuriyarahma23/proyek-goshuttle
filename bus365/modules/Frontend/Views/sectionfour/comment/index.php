...
<div class="table-responsive">
 <table class="table display table-bordered table-striped table-hover basic" id="howitwork">
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col"><?php echo lang("Localize.add_comment") ?> </th>
      <th scope="col"><?php echo lang("Localize.designation") ?> </th>
  ...
  <?php foreach ($secFourComment as $kye =>  $value) : ?>
    ...
    <tr>
      ...
      <td><?php echo $value->person_name; ?></php></td>
      <td><?php echo $value->person_detail; ?></php></td>
      <td><?php echo $value->description; ?></php></td>
      <td><?php echo $value->serial; ?></php></td>
      <td>
          <form action="<?php echo base_url(route_to('delete-section-four-comment',$value->id ))?>" id="sectioforudelete" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
