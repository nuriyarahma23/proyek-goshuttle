                              ...
                              <div class="col-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 mt-3">
                                        <label for="first_name"><?php echo lang("Localize.city_name") ?></label>
                                        <input type="text" name="first_name" class="form-control" value="<?php echo old('first_name') ?? $employee->first_name ?>" placeholder="<?php echo lang("Localize.city_name") ?>" aria-label="First name" required>
                                    </div>

                                    <div class="col-3 mt-3">
                                        <label for="last_name"><?php echo lang("Localize.last_name") ?></label>
                                        <input type="text" name="last_name"  class="form-control" value="<?php echo old('last_name') ?? $employee->last_name ?>" placeholder="<?php echo lang("Localize.last_name") ?>" aria-label="Last name" required>
                                    </div>


                                    <div class="col-3 mt-3">
                                      <label for="employeetype_id"><?php echo lang("Localize.employee") ?>  <?php echo lang("Localize.type") ?></label>
