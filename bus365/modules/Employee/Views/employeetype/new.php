					...
					<div class="col-4">
						...
						<div class="row">
							...
							<div class="col-12 mt-3">
									<label for="type"><?php echo lang("Localize.employee") ?> <?php echo lang("Localize.type") ?></label>
									<input type="text"  name ="type" value="<?php echo old('type') ?>" class="form-control" placeholder="<?php echo lang("Localize.employee") ?> <?php echo lang("Localize.type") ?>">
							</div>
