...
<form action="<?php echo base_url(route_to('update-vehicle',$vehical->id))?>" id="vehicalupdate" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
  ...
  <div class="col-3">
    ...
    <input type="text" placeholder="Reg No"  name ="reg_no" value="<?php echo esc(old('reg_no'))?? $vehical->reg_no  ?>" class="form-control"  >
 </div>

 <div class="col-3">
  <label for="engine_no" class="form-label"><?php echo lang("Localize.eng") ?> <?php echo lang("Localize.no") ?> :</label>
    <input type="text"  name ="engine_no" id="engine_no" placeholder="Eng No" value="<?php echo esc(old('engine_no'))?? $vehical->engine_no ?>" class="form-control">
 </div>


  <div class="col-3">
  <label for="model_no" class="form-label"><?php echo lang("Localize.model") ?> <?php echo lang("Localize.no") ?> :</label>
    <input type="text"  name ="model_no" id="model_no" placeholder="Model No" value="<?php echo esc(old('model_no')) ?? $vehical->model_no ?>" class="form-control">
  </div>
  ...
  <label for="chasis_no" class="form-label"><?php echo lang("Localize.chassis") ?> <?php echo lang("Localize.no") ?> :</label>
     <input type="text"  name ="chasis_no" id="chasis_no" placeholder="Chasis No" value="<?php echo esc(old('chasis_no')) ?? $vehical->chasis_no ?>" class="form-control">
	</div>

  <div class="col-3">
    <label for="woner" class="form-label"><?php echo lang("Localize.woner") ?> :</label>
    <input type="text"  name ="woner" id="woner" placeholder="Woner" value="<?php echo esc(old('woner')) ?? $vehical->woner  ?>" class="form-control">
	</div>


  <div class="col-3">
    <label for="woner_mobile" class="form-label"><?php echo lang("Localize.woner") ?> <?php echo lang("Localize.mobile") ?> :</label>
  <input type="text"  name ="woner_mobile" id="woner_mobile" value="<?php echo esc(old('woner_mobile')) ?? $vehical->woner_mobile  ?>" placeholder="Owner Mobile" class="form-control"  >
	</div>


  <div class="col-3">
    <label for="company" class="form-label"><?php echo lang("Localize.company") ?> ::</label>
  <input type="text"  name ="company" id="company" value="<?php echo esc(old('company')) ?? $vehical->company ?>" placeholder="Company" class="form-control"  >
	</div>
