			...
			<form action="<?php echo base_url(route_to('create-role'))?>" id="roleform" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-4">
										<div class="row">
										<div class="col-12">
											<label for="name" class=""><?php echo lang("Localize.role") ?> <?php echo lang("Localize.name") ?> </label>	
												<input type="text" id="name" name ="name" value="<?php echo esc(old('name'))  ?>" class="form-control text-capitalize"  placeholder="<?php echo lang("Localize.role") ?> <?php echo lang("Localize.name") ?>">
											</div>
