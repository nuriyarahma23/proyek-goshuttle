				...
				<div class="row">
					...
					<div class="col-4">
						<div class="row">
								...
								<div class="col-12 ">
									<label for="name"><?php echo lang("Localize.role") ?> <?php echo lang("Localize.name") ?></label>
									<input type="text"  name ="name" value="<?php echo esc(old('name') ?? $role->name)?>" class="form-control text-capitalize"  >
								</div>
