...
<div class="card mb-4">
      ...
      <?php if ($add_data == true) : ?>  
            <div class="text-end">
                <a class="btn btn-success" href="<?php echo base_url(route_to( 'new-menu' )) ?>"><?php echo lang("Localize.add_menu") ?></a>
            </div>
   <?php endif ?>
 ...
 <table class="table display table-bordered table-striped table-hover basic" id="menulist">
  ...
  <?php foreach ($menu as $kye =>  $value) : ?>
    ...
    <tr>
      ...
      <td>
      <?php echo view_cell('\App\Libraries\AdminMenu::getMenuName','id='.$value->parent_menu_id.'') ?>
      </td>
      ...
      <td>
          ...
          <form action="<?php echo base_url(route_to('delete-menu',$value->id ))?>" id="locatindelete" method="post" class="" accept-charset="utf-8" enctype="multipart/form-data">
