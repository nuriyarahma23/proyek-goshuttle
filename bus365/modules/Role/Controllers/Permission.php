...
class Permission extends BaseController
{
    ...
    function new () {
        ...
        $data['permissionmodule'] = $this->menuModel->orderBy('id', 'ASC')->groupBy("module_name")->findAll();
	...
	public function index()
	{
		...
		$data['role'] = $this->permissionModel->select('permissions.*,roles.name')
        ...
        $add_data = "add_permission";
        $list_data = "permission_list";
		...
		echo view($this->Viewpath.'\permission/index',$data);
	}
...

	{
		...
		echo view($this->Viewpath.'\permission/edit',$data);
	}
