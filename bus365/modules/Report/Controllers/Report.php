...
class Report extends BaseController
{
	...
	
	{
		...
		$this->agentCommissionModel->where('DATE(agentcommissions.created_at) >=', $fromDate)->where('DATE(agentcommissions.created_at) <=', $toDate);
		...
		echo view($this->Viewpath.'\report/agentcommission',$data);
