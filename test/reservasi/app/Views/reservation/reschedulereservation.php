...
<script>
  $(document).on('submit', '#ubahjadwal', function(e) {
    ...
    $.ajax({
      ...
      success: function(response) {
        // Tindakan yang akan dilakukan setelah permintaan sukses
    
        $('#ReservationDetail').modal('hide'); // Menampilkan modal
        $('#rescheduleModal').modal('hide'); // Menampilkan modal reschedule
      ...
      error: function(xhr, status, error) {
        // Tindakan yang akan dilakukan jika terjadi kesalahan
