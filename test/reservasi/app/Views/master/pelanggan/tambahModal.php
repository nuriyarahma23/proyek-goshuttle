 ...
 <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModalTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-scrollable" role="document">
     <div class="modal-content">
       ...
       <form action="<?= base_url('prosestambah-pelanggan') ?>" method="post" enctype="multipart/form-data">
         <div class="modal-body">
           ...
           <div class="form-group">
             ...
             <input class="form-control" type="number" name="jml_reservasi" placeholder="Jml Reservasi" required>
           </div>
           <div class="form-group">
             <label>Jml Reservasi Lunas</label>
             <input class="form-control" type="number" name="jml_reservasi_lunas" placeholder="Jml Reservasi Lunas" required>
           </div>
           <div class="form-group">
             <label>Status</label>
